...
import { fetchAllBrandsAsync, fetchAllCategoriessAsync, fetchAllProductsBYFiltersAsync, selectAllBrands, selectAllCategories, selectAllProducts } from '../productSlice';
// import { brands, category } from '../../../../test';
...
export default function ProductList() {
    ...
    const filters = [
        ...
        },
      {
          ...
          name: 'Category',
          options: categories
          // categories.map(e => ({ value: e.value, label: e.label, checked: e.checked }))
      },
  ]
                ...
                <div className="mx-auto max-w-2xl  px-4 py-2 sm:px-6 sm:py-2 lg:max-w-7xl lg:px-8">
                    ...
                    {products.map((product) => (
                      <Link to="product-details">
                        <div key={product.id} className="group relative border-solid border-2 p-2 rounded-md shadow-md border-gray-200 ">
                          ...
                          <div className="mt-4 flex justify-between font-semibold ">
                            ...
                            <p className="mt-1 text-sm text-gray-500">
                              <StarIcon className='w-6 h-6 inline text-yellow-400'/>
                            <span className='align-bottom font-semibold'> {product.rating}</span>
                            </p>
                            </div>
                            <div> 
                              <p className="text-sm font-medium text-gray-00 mb-2"> 
                                $
                                {
                                  Math.round(
